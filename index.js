...
function hotelsSortedByPriceLowToHigh(hotel1, hotel2) {
  return hotel1.price - hotel2.price
};

function hotelsSortedByPriceHighToLow(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === "low-to-high")  {
    hotelsCopy.sort(hotelsSortedByPriceLowToHigh);
    } else {
      hotelsCopy.sort(hotelsSortedByPriceHighToLow);
    }
  res.json({ hotels: hotelsCopy});
});

function hotelsSortedByRatingLowToHigh(hotel1, hotel2) {
  return hotel1.rating - hotel2.rating;
};

function hotelsSortedByRatingHighToLow(hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => { 
  ...
  if (rating === "low-to-high") {
    hotelsCopy.sort(hotelsSortedByRatingLowToHigh);
  }else {
    hotelsCopy.sort(hotelsSortedByRatingHighToLow);
  }
  res.json({ hotels: hotelsCopy });
});

function hotelsSortedByReviewsLeastToMost(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
};

function hotelsSortedByReviewsMostToLeast(hotel1, hotel2) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews === "least-to-most") {
    hotelsCopy.sort(hotelsSortedByReviewsLeastToMost);
  } else {
    hotelsCopy.sort(hotelsSortedByReviewsMostToLeast);
  }
  res.json({ hotes: hotelsCopy});
});
